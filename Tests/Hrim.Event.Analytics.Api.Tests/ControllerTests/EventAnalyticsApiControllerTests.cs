...
public class EventAnalyticsApiControllerTests {
    private readonly EventAnalyticsApiController _controller;

    public EventAnalyticsApiControllerTests() {
        _controller = new EventAnalyticsApiController(Substitute.For<IApiRequestAccessor>());
    }

    private MethodInfo GetProcessCqrsResult<TEntity>() where TEntity : HrimEntity? {
    ...
    public void ProcessCqrsResult_Given_EntityIsDeleted_Returns_EmptyResult() {
        var dynMethod  = GetProcessCqrsResult<UserEventType?>();
