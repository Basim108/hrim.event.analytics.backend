...
public class OccurrenceEventControllerValidationTests : BaseEventControllerValidationTests
{
    ...
    protected override BaseEvent GetBaseEventCreateRequest()
    {
        return _occurrenceEventCreateRequest;
    }

    protected override BaseEvent GetBaseEventUpdateRequest()
    {
        return _occurrenceEventUpdateRequest;
    }
