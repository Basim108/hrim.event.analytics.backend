...
public static class EfCoreLogs {
    ...
    public const string CONCURRENT_CONFLICT                = "Concurrent Conflict: Operation={Operation}, ExistedConcurrentToken={ExistedConcurrentToken}, OperationConcurrentToken={OperationConcurrentToken}, EntityType={EntityType}.";
