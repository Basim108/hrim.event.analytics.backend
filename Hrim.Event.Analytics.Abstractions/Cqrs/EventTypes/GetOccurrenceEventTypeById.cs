...
public record GetOccurrenceEventTypeById(Guid EventTypeId, bool IsNotTrackable, Guid CorrelationId)
    : BaseRequest(CorrelationId), IRequest<OccurrenceEventType?>;